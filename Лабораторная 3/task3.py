...
def count_letters(text):
    """
    Подсчитывает количество каждой буквы в тексте (без учета регистра).

    Args:
        text: Входной текст.

    Returns:
        Словарь, где ключи — буквы нижнего регистра, значения — количество вхождений.
    """
    letter_counts = {}
...
def calculate_frequency(letter_counts):
    ...
    Returns:
        Словарь, где ключи — буквы, значения — частоты (доля от общего количества).
    """
